...
while($row = $result->fetch_assoc()){
    ...
    echo $row["Amount"];
    echo "</td> ";
    echo '<td><a href="updatetour.php?cid='.$row["ID"].' ">Update</a></td>
        <td><a href="deletetour.php?cid='.$row["ID"].' ">Delete</a></td>';
}
?>
<div class="content">
        <p> <a href="addtour.php" style="color: blue;"> Add Tour </a></p><br>
</div>
</tbody>
</table>
</div>
